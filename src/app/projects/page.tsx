  ...
  return (
    <div>
      <div className="min-h-screen pt-10 max-w-4xl m-auto">
        ...
        <div
            className="mt-10 px-5 grid gap-y-4 gap-x-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 bg-red-50  bg-transparent">
            ...
            return (
                ...
                >
                  <div className="bg-white w-full h-full rounded-md space-y-2">
                    <Image className={"w-full rounded-sm"} src={data.image} alt={`${data.name} Image`} width={400}
                           height={200}/>

...
export default function Footer() {
    ...
    const socialIcons: Array<{icon: React.ReactNode, title:string, url: string}> = [
    ...
    return (
        <div className={"bg-gray-200 p-10 flex items-center justify-between"}>
            <p className={"text-gray-600"}>&copy;2024 Vinaypartap Singh | Portfolio</p>
